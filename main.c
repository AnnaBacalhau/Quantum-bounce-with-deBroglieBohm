/* EMBORA CHAME-SE BIACHI, É NA VERDADE AS CONTAS RELACIONADAS AO POTENCIAL EXPONENCIAL
 * na falta de saber usar o gsl vou definir uma funcao int(t, a) que por hora sera a^ (-3) * t_step, mas que futuramente sera a integral 
 * main.c
 * Copyright (C) 2016 
 * 
